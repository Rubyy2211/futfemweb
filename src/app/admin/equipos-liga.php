...
<body>
    ...
    <div class="contenedor">
        ...
        <div id="equipos-container" class="row"></div>
    </div>
    <script>
        ...
        if (ligaId) {
            ...
            console.error('ID de liga no encontrado en la URL');
        }


        async function cargarEquipos(ligaId) {
            try {
                const response = await fetch(`../../api/equiposxliga?liga=${ligaId}`);
                ...
                if (data.success.length > 0) {
                    ...
                    equipos.forEach(equipo => {
                        ...
                        img.src = equipo.escudo; // Usar el campo correcto
                        img.className = `liga-${equipo.id_equipo}`;
                        img.alt = `Imagen de ${equipo.nombre}`;
                        img.style.width = '100%';
                        img.style.zIndex = '+1';
